...
#---[SECTION START]---
# Set up the Wordpress pre-requisities (copied from wordpress Dockerfile)
...
#---[SECTION START]---
# Install Wordpress and configure for Unit
#
WORKDIR /var/www
RUN curl -s https://wordpress.org/latest.tar.gz | gzip -cd | tar xfv -
